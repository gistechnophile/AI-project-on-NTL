"""
Download GHSL GHS-BUILT-V R2023A (2020 epoch, 100m) and align it to the
...
URL = (
    ...
    "GHS_BUILT_V_GLOBE_R2023A/GHS_BUILT_V_E2020_GLOBE_R2023A_54009_100/V1-0/"
    "GHS_BUILT_V_E2020_GLOBE_R2023A_54009_100_V1_0.zip"
)

PROJECT_ROOT = Path(__file__).resolve().parent.parent
RAW_DIR = PROJECT_ROOT / "data" / "raw"
ZIP_PATH = RAW_DIR / "GHS_BUILT_V_E2020_GLOBE_R2023A_54009_100_V1_0.zip"
REF_PATH = PROJECT_ROOT / "data" / "aligned" / "border_mask.tif"
OUT_PATH = PROJECT_ROOT / "data" / "aligned" / "built_up_volume_2020_ghsl_100m_aligned.tif"

CHUNK_SIZE = 1024 * 1024  # 1 MiB
NODATA_UINT32 = 4294967295
# ------------------------------------------------------------------
...
def align_raster(src_path: Path, ref_path: Path, out_path: Path):
    ...
    with rasterio.open(src_path) as src:
        # GHSL BUILT-V values are cubic metres of built-up volume per 100m pixel.
        # We normalise to "millions of cubic metres" to keep CNN inputs sane.
        SCALE = 1_000_000.0
        ...
        with rasterio.open(out_path, "w", **kwargs) as dst:
            ...
            # Do NOT pass src_nodata for uint32 max value; rasterio rejects it.
            reproject(
            ...
            # Mask nodata residuals and scale
            data[data >= NODATA_UINT32 - 1] = 0.0
